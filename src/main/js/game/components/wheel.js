define(require => {
    ...
    function init() {
        topWheel = displayList.bonusWheelTopDiv;
        middleWheel = displayList.bonusWheelMiddleDiv;
        bottomWheel = displayList.bonusWheelBottomDiv;
        ...
        wheelMap[2].forEach((e, i, a) => {
            let radius = middleWheel.height / 2;
